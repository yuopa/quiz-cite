...
def add_questions():
    questions = [
        ...
        ('''В океане остров. На острове тюрьма, вокруг вода. Из тюрьмы сбежал зек, перелез через стенку, прыгнул в моторную лодку и погреб изо всех сил.
         Охранники прыгнули в более быструю моторную лодку и погнались за ним. Догнали, скрутили, схватили за волосы, стукнули головой о борт, увезли обратно в тюрьму. 
         В этой истории есть 3 нестыковки.''', 'В океане стена не нужна', 'В океане нет островов', 'В океане нет тюрем', 'В лодках весел нет')
        ('В каком слове 5 буквы Ы?', 'Человек, катающийся на вылысыпеде', 'Огурец', 'Я таджик', 'Восемь')
        ('Три?', 'Пять', 'Да.', 'Кто я?', 'А ты кто?')
        ('В общем, есть два стула...', 'На одном пики точеные..', 'Я не сидевший', 'Вилкой в глаз или что?', 'Три.')
    ]
    open()
